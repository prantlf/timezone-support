...
const { initializeTimeZones, listTimeZones, getTimeZone } = require('../dist/lookup-convert')
const data = {
  zones: [
...
it('is exported as a function', () => {
  expect(typeof initializeTimeZones === 'function').toBeTruthy()
})
...
it('populates time zone aliases', () => {
  ensureInitialization()
  const berlin = getTimeZone('Etc/Test')
  expect(typeof berlin === 'object').toBeTruthy()
