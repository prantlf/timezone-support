...
```html
<script src="https://unpkg.com/timezone-support@1.5.2/dist/lookup-convert.umd.js"></script>
<script src="https://unpkg.com/timezone-support@1.5.2/dist/data-2012-2022.umd.js"></script>
<script>
  (() => {
...
```html
<script src="https://unpkg.com/timezone-support@1.5.2/dist/index-2012-2022.umd.js"></script>
<script>
  (() => {
